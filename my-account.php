                ...
                <div class="col-12">
                    ...
                    <div class="my-account-area">
                        ...
                        <div class="col-xl-8 col-md-8">
                                ...
                                <div class="tab-pane fade show active" id="pills-dashboard" role="tabpanel" aria-labelledby="pills-dashboard-tab">
                                    <div class="my-account-dashboard account-wrapper">
                                        ...
                                        <div class="welcome-dashboard m-t-30">
                                            ...
                                            ?>
                                                <p>Hello, <strong><?php echo $row['FirstName']; ?> <?php echo $row['LastName']; ?></strong> (If Not <strong><?php echo $row['LastName']; ?> !</strong> <a href="login.php">Logout</a> )</p>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="pills-address-tab" role="tabpanel" aria-labelledby="pills-account-tab">
                                <div class="my-account-details account-wrapper">
